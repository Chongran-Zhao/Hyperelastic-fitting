...
legend('UT Experimental', 'UT GS',...
       'ET Experimental', 'ET GS',...
       'PS Experimental', 'PS GS',...
       'Location', 'northwest', 'FontSize', 16);

title('GS Model Fitted Curves', 'FontSize', 18);
...
legend('UT Experimental', 'UT Ogden',...
       'ET Experimental', 'ET Ogden',...
       'PS Experimental', 'PS Ogden',...
       'Location', 'northwest', 'FontSize', 16);
