...
% Prescribed stretch
UT_x = linspace(1, 8, 10);
ET_x = linspace(1, 5, 10);
PS_x = linspace(1, 5, 10);
...
% Unit of mu: MPa
GS_paras_0 = [1.0, 1.0, 1.0, 1.0, 3.0, 2.0];
...
[GS_paras, ~] = ga(objectiveFunction, nvars, [], [], [], [], lb, ub, [], options);
